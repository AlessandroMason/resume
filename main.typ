...
#category-title(
  ...
  #job-container(
    "AI Systems Engineer Intern", "Tenfold AI", "Real-time bilingual voice AI interface", "June 2025", "Present", "Hsinchu, TW",
  )[
  ...
  #job-container(
    "Developer", "Penske", "AI-powered sales training platform", "January 2025", "June 2025", "Cleveland, OH",
  )[
    - Led a team of 6 to build a platform training 35,000+ Penske salesforce; Developed a system of 10+ AI agents. Optimized compute pipelines using six NVIDIA RTX A6000 GPUs, reducing latency by 30% (\<600ms).
  ]

  #job-container(
    "MoE/MoA Researcher", "Rice/CWRU AI Research", "Mixture-of-Experts research", "January 2025", "Present", "Hybrid",
  )[
    - Collaborated with Prof. Xu and PhD M.Z. on research in Mixture-of-Experts (MoE) and Attention Experts. Conducted 100+ experiments on custom MoE models, reducing LLM's energy consumption by 73%. Engineered HPC training pipelines from 2 to 13 GPUs, reducing cycle time by 67%.
  ]

  #job-container(
    "CEO & CFO", "Kayros Attendance", "IoT attendance tracking system", "June 2024", "June 2025", "Remote",
  )[
    - *Leadership & Product* #link("https://www.linkedin.com/company/kairos-attendance/")[LinkedIn] | #link("https://youtu.be/5qTS-ZBg_Co")[Demo] | #link("https://k4ros.com")[Website]
      Managed a team of 6 supporting 10 university professors and 800+ weekly users, processing 36,757 records. Designed, built, and manufactured 11 IoT portable scanners. Independently developing a 15k+ line codebase. Presented 9 pitches to audiences of 400+, securing \$7,000+ in non-dilutive grants.
  ]

  #job-container(
    "POS Technical Support", "Case Western Reserve", "Campus point-of-sale maintenance", "September 2023", "Present", "Cleveland, OH",
  )[
    - Maintained 7 campus POS locations (5,000+ daily users) 12–14 hrs/week, ensuring 99.9% uptime.
  ]

  #job-container(
    "CEO & CFO", "Kayros AI", "AI-powered journaling platform", "July 2022", "Present", "Remote",
  )[
    - *Product Development* #link("https://k4ros.com/kairos_journaling.html")[Website] | #link("https://youtu.be/IltM1Zu2Vi4")['22 Hardware] | #link("tel:+12164807520")[+1 (216) 480-7520]
      Directed a 2-person team to develop a 10,000+ line journaling interface serving 255 daily users. Prototyped a 3D ring with BLE electronics and custom firmware; designed a custom PCB (6 × 2 mm). Implemented AI agents with RAG and Gmail Calendar integration.
  ]
]
...
#category-title(
  ...
  #awards-container(
    (
      ([#link("https://grandma-s-wisdom.web.app")[\#1 App Mock-up on Reddit] — Rebuilt Duolingo-style app in 48h; 512 upvotes], "2025"),
      ([CWRU Hackathon Winner — 8th place out of 35 projects], "2025"),
      ...
      ([#link("https://case.edu/entrepreneurship/fellowships/veale-snyder-fellowship-program")[Veale Snyder Fellow (SF–Prague)] — 1 of 12 selected; interviewed Silicon Valley leaders], "2024"),
      ([\$160K Davis Scholar — Full merit scholarship at 50+ U.S. institutions], "2022"),
      ([\$80K UWC Scholar — 1 of 2 awarded from Italy; Full merit scholarship to study in Germany], "2020"),
